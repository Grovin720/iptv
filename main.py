...
daily_mtv="随机一首,"+get_random_url('assets/今日推荐.txt')
...
about="八段锦,"+about_video2
# 瘦身版
# 
all_lines_simple =  ["自动更新(Grovin),#genre#"] +[version] +[about] +[daily_mtv]+read_txt_to_array('专区/about.txt')+ ['\n'] + \
